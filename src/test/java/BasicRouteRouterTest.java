...
class BasicRouteRouterTest {
    ...
    @Test
    void testRouteOfUrlWithEmptyControllerAndFullMethodSwitched() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
